...
2. On first launch, the extension opens the **Panel** (default: bottom of the window).
3. Resize the panel to **desired height, the scene will auto adjust**.

Use the **☰** menu in the panel to access settings, or open full extension settings from the command palette.

**Tip:** -- **Settings -> Panel position** can place it top or bottom.

---

**Enjoying Pixel Weather?** Tips help keep it maintained.

[Buy Me A Coffee](https://www.buymeacoffee.com/quin10o5)
...
| `weather.panelPosition`    | `bottom` | Panel above or below the editor                                                 |
